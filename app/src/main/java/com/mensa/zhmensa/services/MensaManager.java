...
public class MensaManager {
    ...
    private static void put(Mensa mensa) {
    ...
    public static Observable getObservableForCategory(MensaCategory category) {
        Observable obs = category.loadMensasFromAPI();
    ...
    public static List<IMenu> getMenusForIdWeekAndCat(String menuId, Mensa.MenuCategory category, Mensa.Weekday weekday) {
        return MensaManager.getMensaFromId(menuId).getMenusForDayAndCategory(null, null);
    }
